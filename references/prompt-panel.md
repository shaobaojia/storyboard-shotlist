...
```css
.panel-btn{font-size:11px;padding:4px 8px;border:1px solid var(--border);
  border-radius:4px;background:rgba(255,255,255,.04);color:var(--text);cursor:pointer;
  transition:all .15s ease}
.panel-btn:hover{background:rgba(244,63,94,.12);border-color:var(--accent);
  color:var(--head);transform:scale(1.08) translateY(-1px)}
.panel-btn.pinned{background:rgba(244,63,94,.15);border-color:var(--accent);color:var(--accent)}
.btn-close{border-color:transparent;background:transparent;font-size:16px}
